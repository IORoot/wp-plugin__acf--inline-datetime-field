...
if (! class_exists('acf_field_inline_date_and_time_picker')) :

class acf_field_inline_date_and_time_picker extends acf_field
{
    ...
    */
    public function __construct()
    {
        ...
        // vars
        $this->name = 'inline_date_time_picker';
        $this->label = "Inline Date Time Picker";
    ...
    */
    ...
    public function input_admin_enqueue_scripts()
    {
        ...
        wp_register_script('acf-inlinetimepicker', "{$url}/../../assets/js/input.js", array('acf-input'));
        wp_enqueue_script('acf-inlinetimepicker');
...
// initialize
acf_register_field_type('acf_field_inline_date_and_time_picker');
